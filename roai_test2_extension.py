...
from isaacsim.examples.interactive.user_examples import RoaiTest2


class RoaiTest2Extension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "Roai Test2"
        self.category = "MyExamples"

        ui_kwargs = {
            "ext_id": ext_id,
            "file_path": os.path.abspath(__file__),
            "title": "My Roai Test2 Example",
