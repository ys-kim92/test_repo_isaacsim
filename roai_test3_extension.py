...
from isaacsim.examples.interactive.user_examples import RoaiTest3


class RoaiTest3Extension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.example_name = "Roai Test3"
        self.category = "MyExamples"

        ui_kwargs = {
            "ext_id": ext_id,
            "file_path": os.path.abspath(__file__),
            "title": "My Roai Test3 Example",
